...
def build(ip,port,output,ngrok=False,ng=None):
    ...
    try:
        ...
        #Very much uncertaninity but cant think any other way to do it xD =INCA MA GANDESC=
    ...
    if not resOut.returncode:
        ...
        # if you are interested :>>>full source = ilusionxx@protonmail.com  
        # gold =0= errors 